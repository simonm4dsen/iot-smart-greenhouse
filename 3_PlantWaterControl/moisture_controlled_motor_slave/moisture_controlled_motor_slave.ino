...
const int motorPin = 9;           // Pin to activate the motor
...
const int FREQ_1 = 863000000;  // Radio frequency for data transmission [Hz]
...
void setup()
  {
    pinMode(motorPin, OUTPUT);    // Setup the digital pin to activate the motor
