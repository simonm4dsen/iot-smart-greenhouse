...
void SlaveToMaster::begin(SoftwareSerial loraSerial)
  {
...
void SlaveToMaster::setupLora(SoftwareSerial loraSerial)
  {
...
void SlaveToMaster::receiveSync(SoftwareSerial loraSerial)
  {
...
*/
void SlaveToMaster::checkTransmission(SoftwareSerial loraSerial)
  {
    str = loraSerial.readStringUntil('\n');
    delay(20);
...
int SlaveToMaster::receiveData(SoftwareSerial loraSerial)
  {
    int data_rx=0;
    loraSerial.println("radio rx 0");               // Set the receiver in Continuous Reception mode
    str = loraSerial.readStringUntil('\n');
